...
public class RailRoad extends Square{
	...
	public RailRoad(String nameOfSquare, int price, int rent) {
	...
	public  void doAction(Player player, Board board){
		if(player.getMoney().getMoney() >= price) {
			if(this.hasOwner() == 0){
				...
				System.out.println("There is an owner"+this.getOwner().getName()+", you have to pay rent! The rent is: "+rent+"TL");
