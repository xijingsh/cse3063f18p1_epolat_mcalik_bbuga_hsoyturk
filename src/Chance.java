...
public class Chance extends Square {
	...
	public void doAction(Player player,Board board){
		...
		if(randomChanceCard == 0) {
			...
			board.chanceAction(player, player.getLocation());
		}
